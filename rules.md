...
- 对于一个复杂需求，在对应项目的 `docs/$subject` 目录创建 Markdown；文档的
  权威类型、依赖、worked example 和 reconciliation anchor 遵循
  [`designs/agent-ready-docs.md`](designs/agent-ready-docs.md)，不要把完整设计
  复制进一次性 Agent prompt。
