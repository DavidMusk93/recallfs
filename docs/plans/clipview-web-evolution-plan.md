...
> 工作副本现为 `projects/clipvault`（GitHub `DavidMusk93/clipvault`）。下文路径里的 `projects/ClipView` 已随目录重命名。
...
- **文件路径**:
  - `projects/clipvault/ClipFlow/WebServer.swift`
  - `projects/clipvault/ClipFlow/ClipboardMonitor.swift`
  - `projects/clipvault/ClipFlow/DatabaseManager.swift`
- **实施步骤**:
...
- **文件路径**:
  - `projects/clipvault/web/` (前端工程根目录)
  - `projects/clipvault/web/src/App.tsx`
  - `projects/clipvault/web/src/components/ClipboardList.tsx`
  - `projects/clipvault/web/src/components/RichTextEditor.tsx`
- **实施步骤**:
...
- **文件路径**:
  - `projects/clipvault/web/src/components/RichTextEditor.tsx`
  - `projects/clipvault/web/src/components/CodePreview.tsx`
- **实施步骤**:
...
- **文件路径**:
  - `projects/clipvault/web/src/components/ImageOcrViewer.tsx`
  - `projects/clipvault/ClipFlow/iCloudSyncManager.swift`
- **实施步骤**:
